...
namespace TrkrLite.Models
{
    public class TrkrLiteModels
    {
    }
    ...
    public class load_post_enquiry
    {
        ...
        public string truck_id { get; set; }
        public string driver_id { get; set; }
        public string geocode_km{ get; set; }
        public string geo_flag { get; set; }
    ...
    public class orders
    {
        ...
        public decimal total_kms { get; set; } // by sandip on 2/4/2016
        public decimal points { get; set; } // by sandip on 2/4/2016
        ...
        public string receiver_mobile { get; set; }
        public string receiver_email { get; set; }
        public decimal distance_kms_to_origin { get; set; }
    ...
    public class OwnerDriverTag
    {
        ...
        public string owner_id { get; set; }
        public string driver_id { get; set; }
        public string driver_tag { get; set; }
